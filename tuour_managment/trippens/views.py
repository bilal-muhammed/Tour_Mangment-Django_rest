...
from admin_requirments.serializers import AddInetenarySerialiser, CreateTourFormSerialiser
from .models import*
...
# class CreatedTourList(generics.ListAPIView):
#     queryset = Tour.objects.all()
#     serializer_class = CreatedTourSerializer
...
#     try:
#         get = Place.objects.filter(tour=id)
    
#         print("hjkhjhjkhjkhkjhkjhkjhkjhkjhkjhjkhkjhkj")

#     except Place.DoesNotExist:
#         return Response(status=status.HTTP_404_NOT_FOUND)

#     serializer = PlaceSerializer(read_only = True)
#     print(serializer)
